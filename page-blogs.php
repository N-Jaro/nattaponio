...
<main class="flex-grow pt-32 pb-20 px-6 relative">
    ...
    <div class="max-w-6xl mx-auto relative z-10">
        <!-- Header Section matching front-page geometry style -->
        <section class="relative pt-10 pb-16 overflow-hidden">
            <div class="container mx-auto px-6 relative z-10">
                <div class="max-w-3xl mx-auto text-center">
                    <h1 class="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight whitespace-pre-line"><?php echo esc_html(nattaponio_get_theme_option('nattaponio_blog_title_white', 'Blog &')); ?> <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400"><?php echo esc_html(nattaponio_get_theme_option('nattaponio_blog_title_green', 'Learning Notes')); ?></span></h1>
                    <div class="w-24 h-1 bg-gradient-to-r from-emerald-400 to-cyan-400 mx-auto mb-8 rounded-full"></div>
                    <p class="text-lg text-slate-400 leading-relaxed font-sans">
                        <?php echo esc_html(nattaponio_get_theme_option('nattaponio_blog_description', 'A curated repository of technical deep-dives, workspace aesthetics, and the pursuit of the perfect brew.')); ?>
                    </p>
                </div>
            </div>
        </section>
        ...
        <div class="flex flex-wrap gap-3 mb-12">
            <a href="<?php echo esc_url(get_permalink()); ?>" class="bg-primary hover:bg-primary/90 text-[#020617] font-semibold px-6 py-2.5 rounded-full text-sm transition-colors">All Stories</a>
            <?php
...
endforeach; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php
// Custom query to get all posts while on a static page
